...
export const FEST_EVENTS: EventItem[] = [
  {
    ...
    venue: "Radhakrishnan Computer Center",
  ...
  },
  {
    ...
    day: 1,
    time: "Day 1 · Afternoon Session",
    venue: "Main Auditorium Seminar Complex",
  ...
  },
  {
    ...
    day: 2,
    time: "Day 2 · Morning Session",
    venue: "Department of Mathematics Seminar Hall",
    prizePoolLabel: "Trophies & Cash Bounties",
  ...
  },
  {
    ...
    venue: "Computer Science Server Labs",
    prizePoolLabel: "Trophies & Cyber Bounties",
  ...
  },
  {
    ...
    venue: "East Campus Auditorium",
    prizePoolLabel: "Exciting Bounties & Medals",
  ...
  },
  {
    ...
    fullDesc: "Celebrate three days of building and competing! Bass-heavy synth drops, laser projections, glowing wristbands, and an electric atmosphere at HBTU Open Air Theatre.",
    day: 3,
    time: "Day 3 · Grand Finale Evening",
    venue: "HBTU Open Air Theatre (OAT)",
